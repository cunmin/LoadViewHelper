...
public class LoadViewHelper {
    ...
    static DefaultSettingCallBack layoutListener = new DefaultSettingCallBack() {
        @Override
...
//    private View emptyView,errorView,loadView;
    ...
    private int loadLayoutRes = layoutListener.loadLayoutRes();

    private int emptyLayoutRes = layoutListener.emptyLayoutRes();

    private int errorLayoutRes = layoutListener.errorLayoutRes();
    ...
    public LoadViewHelper attach(ViewGroup container){
        ...
        if(null!=contentView){
            ...
            frameLayout.addView(contentView,getMatchParentLayoutParams());
